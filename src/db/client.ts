...
let databaseFilePath: string = './job-copilot.db';

export async function getDatabase(dbPath = './job-copilot.db'): Promise<Database> {
  if (dbInstance) return dbInstance;

  databaseFilePath = path.resolve(process.cwd(), dbPath);
...
export function saveDatabase(): void {
  if (!dbInstance || !databaseFilePath) return;
